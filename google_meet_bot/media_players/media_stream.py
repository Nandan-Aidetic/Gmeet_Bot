...
class VirtualMediaStreamer:
    ...
    def stream_video_and_audio(self):
        ...
        ffmpeg_command = [
            ...
            "-f",
            "pulse",
            "demo_sttream",  # Virtual microphone
        ]

        subprocess.run(ffmpeg_command)

    def play_audio(self):
        """Plays audio to the virtual microphone using ffmpeg."""
        ffmpeg_command = [
            "ffmpeg",
            "-re",
            "-i",
            self.audio_path,  # Path to the audio file
            "-f",
            "pulse",
...
if __name__ == "__main__":
    streamer = VirtualMediaStreamer("/home/nandan/Downloads/hello.mp4")
